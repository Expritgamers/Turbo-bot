...
global.SESSION_ID = process.env.SESSION_ID || 'KANGO~IpYQSACR#DKexHX35G6_rNaPeRW5K2x9temlsCipLY2jWs0RB6kk' 
//Enter your 𝙆𝘼𝙉𝙂𝙊-𝙓𝙈𝘿 session id here; must start with KANGO~

//--------------------[ BOT NAME ]----------------------//

global.botname = process.env.BOT_NAME || 'MEPPE-𝙓𝙈𝘿' 

//-----------------[ OWNER NUMBER ]------------------//

global.ownernumber = process.env.OWNER_NUMBER || '237671080340' 

//-----------------[ OWNER NAME ]------------------//

global.ownername = process.env.OWNER_NAME || 'MEPPE BOT' 
...
global.author = process.env.STICKER_AUTHOR_NAME || "MEP" 
